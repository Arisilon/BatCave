...
class Client:
    ...
    def __init__(self, ctype: ClientType, /, name: str = '', connect_info: str = '', *, user: str = '',  # pylint: disable=too-many-arguments
        ...
        if not user:
            match self._type:
                case ClientType.file | ClientType.git:
        ...
        if create_client:
            ...
            if not client_name:
                match self._type:
                    case ClientType.file:
                        pass
                    case ClientType.git | ClientType.perforce:
    ...
    def create_branch(self, name: str, /, *, branch_from: str = '', repo: str = '', branch_type: str = '', remote_branch: str = '',
        ...
        match self._type:
            ...
            case ClientType.git:
                ...
                self._client.git.checkout('-b', name, *args)
                if no_execute:
                    return []
    ...
    def get_cms_sys_value(self, var: str, /) -> str:
        ...
        if var in environ:
            return environ[var]
        match self._type:  # pylint: disable=too-many-nested-blocks
            case ClientType.perforce:
                if sys.platform == 'win32':
    ...
    def remove_files(self, *files: str, no_execute: bool = False) -> List[str]:
        ...
        result: List[str] = []
        match self._type:
            case ClientType.git | ClientType.file:
                if not no_execute:
                    if self._type == ClientType.git:
